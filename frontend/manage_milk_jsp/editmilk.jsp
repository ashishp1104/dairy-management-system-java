...
<%@include file="dropdown.jsp" %>
  ...
  try{
	  ...
	  String query="select * from milk where id="+id;
  ...
  %>
     <form action="updatemilk" method="post" class="mt-3 text-white">
   <!-- email-field --> 
   <div class="container">
    ...
    <input placeholder="Enter Date here" name="date" value="<%=rs.getDate("date") %>" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<div class="col md-6 mb-3">
<label for="cars" class="text-dark">Farmer</label>
  <%
  try{
	  Class.forName("com.mysql.cj.jdbc.Driver");
...
%>
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Quantity here" value="<%=rs.getString("milk_quantity") %>" name="milk_quantity" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="Container row"  >
    ...
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Temparature</label>
    <input placeholder="Enter Temparature here" value="<%=rs.getString("temp") %>" name="temp" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Payment</label>
    <input placeholder="Enter payment here" value="<%=rs.getString("payment") %>" name="payment" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <button type="submit" class="btn btn-warning" name="feedback" id="feedback">Submit</button>
          ...
          <button class="btn btn-info text-decoration-none text-center"><a class=text-dark " aria-current="page" href="Managemilk.jsp">Back</a></button>
  <%
	  }
  }catch(ClassNotFoundException e){
	  e.printStackTrace();
