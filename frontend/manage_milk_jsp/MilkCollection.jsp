...
<%@include file="dropdown.jsp" %>
        ...
        <p class="text-center">Add Milk Collections</p>
            <form action="<%=application.getContextPath() %>/milkservlet" method="post" class="mt-3 text-white">
   <!-- email-field --> 
   <div class="Container row"  >
  <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Date</label>
    <input placeholder="Enter Date here" name="date" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
%>
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Quantity here" name="milk_quantity" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Temparature</label>
    <input placeholder="Enter Temparature here" name="temp" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="Container row"  >
    ...
    <input placeholder="Enter payment here" name="payment" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
