...
<%@include file="dropdown.jsp" %>
        ...
        <p class="text-center">Manage Milk Collection</p>
  ...
  <tbody>
    <tr>
      ...
      <td><%=rs.getString("milk_quantity") %></td>
      <td><%=rs.getString("temp") %></td>
      <td><%=rs.getString("payment") %></td>
      <td><a href="editmilk.jsp?id=<%=rs.getString("id")%>">Edit</a></td>
      <td><a href="deletemilk.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
