...
<%@include file="dropdown.jsp" %>
        ...
        <p class="text-center">Add Farmer</p>
            <form action="<%=application.getContextPath() %>/farmer" method="post" class="mt-3 text-white">
   <!-- email-field --> 
   <div class="Container row"  >
  <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Name</label>
    <input placeholder="Enter Name here" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter here" name="farm_size" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
