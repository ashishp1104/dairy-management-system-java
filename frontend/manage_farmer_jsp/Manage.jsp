...
<%@include file="dropdown.jsp" %>
        ...
        <p class="text-center">Manage Farm</p>
  ...
  <tbody>
    <tr>
      ...
      <td><%=rs.getString("farm_size") %></td>
      <td><a href="editfarmer.jsp?id=<%=rs.getString("id")%>">Edit</a></td>
      <td><a href="deletefarmer.jsp?id=<%=rs.getString("id")%>">Delete</a></td>
