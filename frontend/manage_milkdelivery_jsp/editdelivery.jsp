...
<%@include file="dropdown.jsp" %>
  ...
  %>
     <form action="updatedelivery" method="post" class="mt-3 text-white">
   <!-- email-field --> 
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Name here" value="<%=rs.getString("cust_name") %>" name="cust_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter here" name="delivery_date" value="<%=rs.getString("delivery_date") %>" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Address here" value="<%=rs.getString("quantity") %>" name="quantity" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Vehical Number</label>
    <input placeholder="Enter here" name="vehical_no" value="<%=rs.getString("vehical_no") %>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Address here" value="<%=rs.getString("dname") %>" name="dname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Driver Contact</label>
    <input placeholder="Enter here" name="dcontact" value="<%=rs.getString("dcontact") %>" type="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <button type="submit" class="btn btn-warning" name="feedback" id="feedback">Submit</button>
          ...
          <button class="btn btn-info text-decoration-none text-center"><a class=text-dark " aria-current="page" href="ManageDelivery.jsp">Back</a></button>
  <%
	  }
