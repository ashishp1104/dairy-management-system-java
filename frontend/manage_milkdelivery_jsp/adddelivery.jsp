...
<%@include file="dropdown.jsp" %>
        ...
        <p class="text-center">Add Delivery</p>
            <form action="<%=application.getContextPath() %>/delivery" method="post" class="mt-3 text-white">
   <!-- email-field --> 
   <div class="Container row"  >
  <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Customer Name</label>
    <input placeholder="Enter Customer Name here" name="cust_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Contact</label>
    <input placeholder="Enter contact here" name="contact" type="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Address here" name="address" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Delivery Date</label>
    <input placeholder="Enter Delivery here" name="delivery_date" type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Quantity here" name="quantity" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Vehical Number</label>
    <input placeholder="Enter Vehical Number here" name="vehical_no" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="col md-6 mb-3">
    ...
    <input placeholder="Enter Driver name here" name="dname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    
  </div>
    <div class="col md-6 mb-3">
    <label for="exampleInputEmail1" class="form-label">Driver Contact</label>
    <input placeholder="Enter Driver Contact here" name="dcontact" type="tel" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <button type="submit" class="btn btn-warning" name="feedback" id="feedback">Submit</button>
   <button type="reset" class="btn btn-light">Print</button>
  </div>
